...
- Developed and back-tested single and multi-factor risk models (Momentum, Earnings Revision, Value, Quality, Growth, Low Volatility) to assess portfolio exposures and build investment strategies.

- Conducted in-depth analysis, backtested, and published report on Ambit’s Accounting Forensic framework, highlighting accounting quality risk in listed companies.

- Build statistical arbitrage frameworks to evaluate pair trading opportunities across equity and index instruments.

- Created index rebalance simulations for Nifty, Sensex, and NSE sectoral indices to estimate passive fund flows.

- Analysed equity derivatives volume and open interest, rollover, volatility to identify risk and arbitrage opportunities.
...
I'm have completed CQF with Fitch Learning.
